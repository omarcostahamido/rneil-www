        ...
        .then(response => {
          if (response) {
            ...
            this.setState({
              ...
              headerImageGallery: this.state.doc.data.home_header_gallery[0]
                .home_header_gallery_image.url
            });
            console.log(
              this.state.doc.data.home_header_gallery[0]
                .home_header_gallery_image.url
            );
          } else {
    ...
    return (
      <div>
        ...
        <Header
          ...
          img={this.state.headerImageGallery}
        />
        <Casestudy_Featured
          title="Casestudy 1"
