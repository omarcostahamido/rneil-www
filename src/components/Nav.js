...
class Nav extends React.Component {
  ...
  handleLogoResize = () => {
    if (window.innerWidth < 720 || document.documentElement.clientWidth < 720) {
      this.setState({
        logoPath:
